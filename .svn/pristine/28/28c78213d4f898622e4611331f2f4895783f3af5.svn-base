...
var getPath = function(){
    var jsPath = doc.currentScript ? doc.currentScript.src : function(){
        var js = doc.scripts
            ,last = js.length - 1
            ,src;
        //script.readyState属性为interative表示脚本正在执行
        for(var i = last; i > 0; i--){
            if(js[i].readyState === 'interactive'){//查找document.scripts集合中readyState属性为interative的script元素的src
                src = js[i].src;
                break;
            }
        }
    ...
    if(!jsPath || jsPath.length===0){
        jsPath=document.getElementById('layui').src;
    }
  ...
  var modules = {
    ...
    ,myTree: 'extend/myTree'
    ,element2: 'extend/element2'
    ...
    ,uploads: 'extend/uploads'
    ,uploads2: 'extend/uploads2'
    ,uploadEdit: 'extend/uploadEdit'
    ,tooltip: 'extend/tooltip'
    ,tmpl: 'extend/tmpl'
    ,initPage: 'extend/initPage'
    ,defaultConfig: 'extend/config'
    ,md5:'extend/md5'
  ...
  Layui.prototype.use = function(apps, callback, exports){
    ...
    if(window.jQuery && jQuery.fn.on){console.log(window.jQuery);
  ...
  Layui.prototype.loadScript=function(src,id,fn) {
  ...
  //css外部加载器
 Layui.prototype.link = function(href, fn, cssname,pre){
        var that = this
  ...
  layui.link(getPath+'font-awesome/css/font-awesome.css',null,'font-awesome',true);
  layui.link(getPath+'css/layui.css',null,'layui',true);
