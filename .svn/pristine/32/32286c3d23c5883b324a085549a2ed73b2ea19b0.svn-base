layui.define(['jquery','util'], function (exports) {
    ...
    var methods={
        ...
        event:function () {
            ...
            body.off('mouseenter',ELEM).on('mouseenter',ELEM,function () {
                var _this = $(this);
                var opt={};
                var _option = _this.data('options')
                    ,position={
            ...
            body.off('mouseleave',ELEM).on('mouseleave',ELEM,function () {
                var _this = $(this),
            ...
            body.off('mouseenter','.'+ELEM_TOOLTIP).on('mouseenter','.'+ELEM_TOOLTIP,function () {
                var tips=$(this);
                clearTimeout(tips.data('timmer'));
            });
            body.off('mouseleave','.'+ELEM_TOOLTIP).on('mouseleave','.'+ELEM_TOOLTIP,function () {
                var tips=$(this);
